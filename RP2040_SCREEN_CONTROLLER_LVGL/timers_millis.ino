void millisTimer() {
  ...
  if ( currentMillis - timer67ms > 67) {
    ...
    timer67msFlag = 1;
    timer67msBlink = !timer67msBlink;
  }

   if ( currentMillis - timer100ms > 100) {
     timer100ms = currentMillis;
     timer100msFlag = 1;
     timer100msBlink = !timer100msBlink;
   }

      if ( currentMillis - timer150ms > 150) {
     timer150ms = currentMillis;
     timer150msFlag = 1;
      timer150msBlink = !timer150msBlink;
   }

   if ( currentMillis - timer200ms > 200) {
     timer200ms = currentMillis;
     timer200msFlag = 1;
     timer200msBlink = !timer200msBlink;
   }
