...
#define TFT_CS   PB0 // Chip select control pin to TFT CS
#define TFT_RST  PB1 // Reset pin to TFT RST (or RESET)
#define TFT_DC   PB2 // Data Command control pin to TFT DC (may be labelled RS = Register Select)
...
#define SPI_FREQUENCY        75000000   // 27MHz SPI clock
//#define SPI_FREQUENCY      55000000   // 55MHz is over-clocking ILI9341 but seems to work reliably!

#define SPI_READ_FREQUENCY   25000000 // Reads need a slower SPI clock, probably ends up at 13.75MHz (CPU clock/16)

#define SPI_TOUCH_FREQUENCY  10000000 // Must be very slow
